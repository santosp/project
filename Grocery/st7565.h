...
#define GLCD_CMD_COLUMN_LOWER		0x00//0b00000000
/** Command: set the most significant 4 bits of the column address. */
#define GLCD_CMD_COLUMN_UPPER		0x10//0b00010000
 ...
 * Paul Santos
 * 1/9/13
 * - Changed all of the constants from binary to HEX so it works with the compiler
 * ----------------------------------------------------------------------------------
 * 1/10/13
 * - Found that the define for GLCD_CMD_SET_PAGE was inproperly converted to HEX
 * 		-Fixed and now can draw to whole LCD
 *
 */
